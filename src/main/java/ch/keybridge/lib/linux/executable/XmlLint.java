...
public class XmlLint {
   ...
   * @since 03/31/15
   */
  private static final String XMLLINT_BINARY = "/usr/bin/xmllint";
   ...
   * @return a non-null TreeSet instance containing a description of all
   *         validation errors (empty if none found)
   ...
   */
  public static Set<String> validate(String xml, Path schema) throws IOException, InterruptedException {
...
//    tempFile.toFile().deleteOnExit();
   ...
   * @throws InterruptedException if the Unix XMLLINT process is interrupted
   */
  public static Set<String> validate(Path xml, Path schema) throws IOException, InterruptedException {
